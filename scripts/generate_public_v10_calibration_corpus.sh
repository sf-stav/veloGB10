...
set -- \
    ...
    --schema-function-corpus "$source_root/johin/function-calling.jsonl" --seed "$seed" --profile v10
...
"$repo_dir/target/release/calib_compose" --model-dir "$model_dir" --output "$output_jsonl" \
    ...
    --source "code=20:1024:$staging_dir/code.jsonl" \
    --source "multilingual=18:768:$staging_dir/multilingual.jsonl" \
    --source "tools_structured=18:2048:$staging_dir/tools_structured.jsonl" \
    --source "agentic_reliability=12:2048:$staging_dir/agentic_reliability.jsonl" \
...
echo "[generate-public-v10] main: $output_jsonl"
echo "[generate-public-v10] long: $long_output"
