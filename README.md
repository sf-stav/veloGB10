...
ranges are across 0–8K context. ¹ TP=2 on the small models (0.8B, 2B) is unoptimized — barriers
dominate at these sizes; run them single-node. **TP=2 vs single**, same harness: 27B **1.2–1.6×** (ratio grows
